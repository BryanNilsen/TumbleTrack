        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(nullable: false),
                    GymnastId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Meets", x => x.MeetId);
                    table.ForeignKey(
                        name: "FK_Meets_Gymnasts_GymnastId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GymnastEventId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymnastEvents", x => x.GymnastEventId);
                    table.ForeignKey(
                        name: "FK_GymnastEvents_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GymnastEvents_Gymnasts_GymnastId",
                        column: x => x.GymnastId,
                        principalTable: "Gymnasts",
                        principalColumn: "GymnastId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymnastEvents_EventId",
                table: "GymnastEvents",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_GymnastEvents_GymnastId",
                table: "GymnastEvents",
                column: "GymnastId");
